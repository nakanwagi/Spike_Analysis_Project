...
title(a1, 'Rat position in blue, first eigenvector only in  red: 2011Data');


a2 = subplot(2, 1, 2);
plot3(x.data, y.data, x.data(x.range), 'b');
hold on;
plot3(x.data, y.data,  eigVec{5}.data(x.range), 'r');
xlabel('x');ylabel('y');zlabel('First Eigen Vector');
title(a2, 'Position Eigvec 5');
hold off;

% print the plot
print('Rat Position and EigVector 1 and 5','-dpng');
