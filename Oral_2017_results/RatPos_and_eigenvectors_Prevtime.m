...
MI_prev32 = nansum(nansum(Hnew .* bsxfun(@minus,bsxfun(@minus,log2(Hnew),lh1),lh2)));

%% Create a Mutual Information vector.

MI_prevt = [MI_prev1, MI_prev2,  MI_prev3,  MI_prev4,...
    MI_prev5, MI_prev6,  MI_prev7, MI_prev8, MI_prev9,...
    MI_prev10, MI_prev11, MI_prev12, MI_prev13, MI_prev14,...
    MI_prev15,  MI_prev16,  MI_prev17, MI_prev18,  MI_prev19,...
    MI_prev20, MI_prev21,  MI_prev22, MI_prev23,  MI_prev24,...
   MI_prev25, MI_prev26,  MI_prev27,  MI_prev28,  MI_prev29,...
   MI_prev30, MI_prev31,  MI_prev32];
