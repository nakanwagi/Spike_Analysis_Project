...
%print( 'MI_on_SimNoisyFRpca1','-depsc');
...
%print('MI_on_SimNoisyFRpca2','-depsc');
...
%print( 'MI_on_SimNoisyFRpca3','-depsc');
...
print( 'MI_on_SimNoisyFRpca4','-depsc');
