...
[SpikeTimes, FireRate] = SimHetSpikes_noisy(tstart, tend, dt);
toc;

disp('Computing mean of prevtime and nextime to generate NewSpikes');tic;
NewSpikes=BoundaryCondition_NANs_noisy(SpikeTimes, dt, time, tstart, tend);
toc;

disp('Computing clean prevtime and nextime functions for synthetic data');
tic;

[prevtime, nextime] = RecomputePrevtimeNextime_noisy(NewSpikes, dt, time, tstart, tend);
toc;
